...
<body>
    ...
    <ul class="nav nav-tabs" style="margin-top:5px">
        <li class="nav-item">
            <a class="nav-link " href="manage.php">ผู้ป่วย</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="customer.php">ญาติ</a>
        </li>
    ...
    ?>  
     ...
     <!-- ตาราง --> 
   <div class="container">
        <h3 class="text-center" style="margin:15px" >ข้อมูลญาติ</h3>
        <div class="row">
            <div class="col-md-12 ">
                <button type="button" class="btn btn-outline-success" style="margin-bottom:15px" data-toggle="modal" data-target="#addUser">+ เพิ่มรายชื่อญาติและผู้ป่วย</button>
            </div>
        </div>
   ...
   <div class="modal fade " id="addUser" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title">เพิ่มรายชื่อญาติและผู้ป่วย</h5>
                ...
                <div class="modal-body">
                    <form action="customer/create.php" method="post" enctype="multipart/form-data">
                        <h4 class="text-center" style="margin-bottom: 20px;">ข้อมูลญาติ</h4>
                        <div class="row">
                            <div class="form-group input-group col-md-6">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="fileimg" id="pic" aria-describedby="inputGroupFileAddon01">
                                    <label class="custom-file-label" for="pic">รูปภาพญาติ</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <hr>
                        <h4 class="text-center" style="margin-bottom: 20px;">ข้อมูลผู้ป่วย</h4>
                        <div class="row">
                            <div class="form-group input-group col-md-6">
                                <div class="custom-file">
    ...
    <div class="modal fade " id="readUser" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title">ข้อมูลญาติ</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade " id="updateCus" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title">แก้ไขข้อมูลญาติ</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
