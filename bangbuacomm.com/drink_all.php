...
<body style="font-family: 'Prompt', sans-serif;">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item" style=" border-radius: 0px; font-size:20px ;">
            <a class="nav-link " id="nav_recommend" href="recommend.php"><?php echo $nav_recommend;?></a>
          </li>
        ...
        <a href="change_drink_all.php?lang=TH">
          <div style="color: white;">TH</div>
        </a>&nbsp;
        <a href="change_drink_all.php?lang=EN">
  ...
  <div class="container">
    ...
    <div class="row text-center">
      ...
      <div class="col-xl-4 col-md-4 col-sm-12 p-2">
        <a href="drink_all.php"><button type="button" id="shopdrink"
            class="btn textstore w-100"><?php echo $shopdrink;?></button></a>
      </div>
      <div class="col-xl-4 col-md-4 col-sm-12 p-2">
        <a href="etc_all.php"> <button type="button" id="shopother"
            class="btn textstore w-100"><?php echo $shopother;?></button> </a>
      </div>
    </div>
    <!-- ร้านเครื่องดื้่มทั้งหมด -->
    <br>
    <br>
    <div class="row mt-5">
      <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 col-12 mb-2 ">
        <h1 class="store-text" id="foodall"><?php echo $drinkall;?></h1>
      </div>
      <?php

          $fetchdata = new DB_con();
          $sql = $fetchdata->fetchdatadrink();
                ...
                <div class="row">
                  ...
                  <div class="col-xl-4 mt-2 col-12">
                    ...
                    <div>
                      ...
                      <div>
                        <h6 id="modal_type"><?php echo $modal_type; ?> <?php echo $row['s_type']; ?></h6>
                      </div>
                    </div>
                    <div class="row">
                      <div>
    ...
    <div class="row">
      <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6 col-6" style="color: white;">
        ...
        <ul type="none" class="p-1">
          <li class="mt-2"><a href="#" class="text-footer"><img src="img/face-logo.png" alt="" class="icon-footer"><span
                class="pl-footer">BangBuaCommunity</span></a>
          </li>
          <li class="mt-2"><a href="#" class="text-footer"><img src="img/line-logo.png" alt="" class="icon-footer"><span
                class="pl-footer">OpenChat</span></a></li>
        </ul>
      </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-color: #EBF1F5;">
          <div class="row">
            ...
            <div class="col-xl-4 mt-2 col-12">
              <h1 class="text-break" id="modal_name"><?php echo $modal_name;?></h1>
              <div>
                <div>
                  <h6 id="modal_type"><?php echo $modal_name;?></h6>
                </div>
              </div>
              <div class="row" >
                <div>
                  <h6 id="modal_detail"><?php echo $modal_detail;?></h6>
                </div>
                <div class="row fluid ">
                  <div class="card ">
                    <div class="card-body card d-flex w-100 " style=" min-height: 150px; height: auto; min-width:280px;  ; background-color: white;">
                ...
                <div class="row mt-2">
                  <br>
                  <div>
                    <h6 id="modal_time"><?php echo $modal_time;?></h6>
                  </div>
                </div>
                <div class="row">
                  <div>
