...
<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = $userdata->registration($id,$fname, $lname, $phone, $password);
	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
				    <div class="app-auth-branding mb-4"><a class="app-logo" href="index.php"><img class="logo-icon mr-2" src="assets/images/app-logo.svg" alt="logo"></a></div>
					...
					<div  class="auth-form-container text-left mx-auto">
						<form method="post" class="auth-form auth-signup-form"> 
							<div class="mb-3">
								...
								<input id="id" name="id" type="text" class="form-control" placeholder="ID"  required="required" onblur="checkusername(this.value)" >								
								<span id="usernameavailable"></span>
							</div>        
							<div class=" mb-3">
								<label class="sr-only" for="fname">Full Name</label>
								<input id="fname" name="fname" type="text" class="form-control" placeholder="Full name"  required="required">
							</div>
							<div class=" mb-3">
								<label class="sr-only" for="lname">Last Name</label>
								<input id="lname" name="lname" type="text" class="form-control" placeholder="Last Name" required="required">
							</div>
							...
							<div class="text-center">
								<button type="submit"  name="submit" id="submit" class="btn app-btn-primary btn-block theme-btn mx-auto">Sign Up</button>
							</div>
						</form><!--//auth-form-->
