...
<head>
	...
	<meta name="description" content="ภาพรวม">
    ...
    <div class="app-wrapper">
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <h1 class="app-page-title">ภาพรวม</h1>
			    
			    <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
				    <div class="inner">
					    <div class="app-card-body p-3 p-lg-4">
						    <h3 class="mb-3">ยินดีต้อนรับ!</h3>
						    <div class="row gx-5 gy-3">
						        <div class="col-12 col-lg-9">
							        
							        <div>หากคุณสงสัยวิธีการใช้งานเว็บใช้ในส่วนต่างๆ โปรดคลิกที่แถบ <a class="text-primary" href="help.php">ช่วยเหลือ</a></div>
							    </div><!--//col-->
							    </div><!--//col-->
						    </div><!--//row-->
			    ...
			    <div class="row g-4 mb-4 p-2 text-center">
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100 ">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1 text-primary">ร้านค้าทั้งหมด</h4> 
								<?php
								$fetchdata = new DB_con();
								$sql = $fetchdata->Countall();
								$row = mysqli_fetch_array($sql)
								?>
							    <div class="stats-figure"><?php echo $row['total'] ?></div>
								<div class="stats-meta">ร้าน</div>
								<?php 

								?>
						    </div><!--//app-card-body-->
						    <a class="app-card-link-mask" href="manageshop.php"></a>
					    </div><!--//app-card-->
				    </div><!--//col-->
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
								...
								$fetchdata = new DB_con();
								$s_type = 'ร้านอาหาร' ;
								$sql = $fetchdata->CountShop($s_type);
								$row = mysqli_fetch_array($sql)
								?>
							    <h4 class="stats-type mb-1 text-primary">ร้านอาหาร</h4>
							    <div class="stats-figure"><?php echo $row['total'] ?></div>
								<div class="stats-meta">ร้าน</div>
						    </div><!--//app-card-body-->
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100 ">
							...
							<?php
								$fetchdata = new DB_con();
								$s_type = 'ร้านของหวานและเครื่องดื่ม' ;
								$sql = $fetchdata->CountShop($s_type);
								$row = mysqli_fetch_array($sql)
							?>
							    <h4 class="stats-type mb-1 text-primary">ร้านของหวานและเครื่องดื่ม</h4>
							    <div class="stats-figure"><?php echo $row['total'] ?></div>
								<div class="stats-meta">ร้าน</div>
						    <a class="app-card-link-mask"></a>
							</div>
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
							...
							<?php
								$fetchdata = new DB_con();
								$s_type = 'ร้านค้าและการบริการอื่นๆ' ;
								$sql = $fetchdata->CountShop($s_type);
								$row = mysqli_fetch_array($sql)
							?>
							    <h4 class="stats-type mb-1 text-primary">ร้านค้าและบริการอื่นๆ</h4>
							    <div class="stats-figure"><?php echo $row['total'] ?></div>
								<div class="stats-meta">ร้าน</div>
						    </div><!--//app-card-body-->
						    <a class="app-card-link-mask" ></a>
