...
if (isset($_POST['submit'])) {
	...
	$newdata['cf_password'] = md5($_POST['cf_password']);
	$a_id  = $_SESSION['a_id'];
	
	if ($newdata['new_password'] !== "" && $newdata['old_password'] !== "" && $newdata['cf_password'] !== "") {
		if ($newdata['new_password'] == $newdata['cf_password']) {
			if ($userdata->changePassword($a_id)) {
				echo "<script>alert('Your new password update successfully!');</script>";
				// echo "<script>window.location.href='settings.php'</script>";

				// echo $success = "Your new password update successfully.";
			} else {
				echo "<script>alert('Old Password is not match!');</script>";
				// echo $error = "Old Password is not match";
			}
		} else {
			echo "<script>alert('New password and confirm password do not matched!');</script>";
			// echo $error = "New password and confirm password do not matched";
		}
	} else {
		echo "<script>alert('Please fill the all fields!');</script>";
		// echo $error = "Please fill the all fields";
	}
}
...
<head>
    ...
    <meta name="description" content="ตั้งค่า">
			...
			<div class="container-xl">
				...
				<div class="row g-4 settings-section">
					<div class="col-12 col-md-4">
						...
						<div class="section-intro">คุณสามารถเปลี่ยนรหัสผ่านการเข้าสู่ระบบได้โดยการใส่รหัสผ่านปัจจุบัน รหัสผ่านใหม่ และยืนยันรหัสผ่านใหม่</div>
					</div>
						...
						<div class="app-card app-card-settings shadow-sm p-4">
							...
							<div class="app-card-body">
								...
								<form method="post" class="settings-form">
									...
									<div class="mb-3">
										<label for="cf_password" class="form-label">ยืนยันรหัสผ่านใหม่</label>
										<input type="password" name="cf_password" class="form-control" id="cf_password">
									</div>
									<button type="submit" name="submit" id="submit" class="btn app-btn-primary">บันทึก</button>
