...
<body style="font-family: 'Prompt', sans-serif;">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style=" background-color: #4C648A;">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="change_search.php?lang=TH">
          <div style="color: white;">TH</div>
        </a>&nbsp;
        <a href="change_search.php?lang=EN">
  ...
  <div class="container">
    ...
    //   $data = $_POST['txtKeyword'];
    //   echo $data;

    //   $sql = $insertdata->search($data);
    //   if ($sql) {
    //     echo "<script>alert('บันทึกข้อมูลสำเร็จ!');</script>";
    ...
    <div class="row text-center">
      ...
      <div class="col-md-6 col-lg-6 col-xl-6 col-sm-6 col-12 ">
        <div class="form-group has-search input-field">
          <span class="glyphicon glyphicon-search form-control-feedback"></span>

          <form name="frmSearch" method="get" action="">
            <input type="text" name="txtKeyword" id="txtKeyword" value="<?= $_GET["txtKeyword"]; ?>" class="form-control " placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $searchbtn; ?>" style="height:80px ; border-radius:22px; background-color: #EBF1F5; ">
    ...
    <div class="row mt-5">
      ...
      <div class="row mt-5">
        <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 col-12 mb-2 ">
          <h1 class="store-text" id="foodall"><?php echo $search ?> "<?php echo $_GET['txtKeyword']; ?>" <?php echo $bangbua ?></h1>
        </div>
      ...
      <?php
      if ($_GET["txtKeyword"] != "") {
        $data = $_GET['txtKeyword'];

        $fetchdata = new DB_con();
        $sql = $fetchdata->search($data);
