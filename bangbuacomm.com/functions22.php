...
class DB_con
{
    ...
    // public function insertpathpic($vdo_id,$vdo_url)
    // {      
    //     $result = mysqli_query($this->dbcon, "INSERT INTO `pictureshop` (`ps_id`, `ps_path`, `s_id`) VALUES ('1', '/img/shops/ข้าวเหนียวมะม่วงแม่เฉลิม/2_1.png', '1');"); 
    //     return $result;
    // }

    // public function fetchdata() {
    //     $result = mysqli_query($this->dbcon, "SELECT * FROM shop"); SELECT t_name FROM shop,type WHERE shop.t_id = type.t_id
    //     return $result;
    // }
    ...
    {
        $result = mysqli_query($this->dbcon, "SELECT * FROM shop LEFT JOIN pictureshop ON shop.s_id = pictureshop.s_id");
    ...
    public function fetchpic($s_id)
    {
        ...
        //$result = mysqli_query($this->dbcon, "SELECT * FROM pictureshop");
        // $result = mysqli_query($this->dbcon, "SELECT * FROM shop,type WHERE shop.t_id = type.t_id");
        return $result;
    }
    ...
    // public function fetchdatareccom1()
    // {
    //     $result = mysqli_query($this->dbcon, "SELECT * FROM shop,recommend WHERE shop.s_id = recommend.r_s_id LIMIT 4");
    //     // $result = mysqli_query($this->dbcon, "SELECT * FROM shop,type WHERE shop.t_id = type.t_id");
    //     return $result;
    // }
