  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style=" background-color: #4C648A;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse"  id="navbarSupportedContent">
                ...
                <a href="change_food_all.php?lang=TH">
                <div style="color: white;">TH</div>
                </a>&nbsp;
                <a href="change_food_all.php?lang=EN">
...
<div class="row mt-5">
      <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 col-12 mb-2 ">
        <h1 class="store-text" id="foodall"><?php echo $foodall; ?></h1>
      </div>
        ...
        <div class="col-md-3 col-lg-3 col-xl-3 col-sm-6 col-6 mb-4">
          <div class="card" data-bs-toggle="modal" data-bs-target="#Modal<?php echo $row['s_id']; ?>">
            ...
            <div class="card-body">
              ...
              <h5 class="card-title "><span id="card_tel"></span> <?php echo $card_tel; ?>: <?php echo $row['s_phone']; ?></h5>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-color: #EBF1F5;">
        <div class="row">
          ...
          <div class="col-xl-4 mt-2 col-12">
            <h1 class="text-break" id="modal_name"><?php echo $modal_name ?> <?php echo $row['s_name']; ?></h1>
            <div>
              <div>
                <h6 id="modal_type"><?php echo $modal_type ?></h6>
              </div>
            </div>
            <div class="row" >
              <div>
